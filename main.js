...
(function(exports) {
      ...
      return function (dictHashableRecord) {
          return function (dictEqRecord) {
              return new Hashable(function () {
                  return Data_Eq.eqRec(dictRowToList)(dictEqRecord);
              }, hashRecord(dictHashableRecord)(Type_Row.RLProxy.value));
          };
      };
  };
          ...
          return function (dictIsSymbol) {
              return function (dictCons) {
                  return new HashableRecord(function () {
                      return Data_Eq.eqRowCons(dictHashableRecord.EqRecord0())(dictCons)(dictIsSymbol)(dictHashable.Eq0());
                  }, function (rlp) {
                      return function (record) {
                          return (hash(dictHashable)(Record.get(dictIsSymbol)(dictCons)(Data_Symbol.SProxy.value)(record)) * 31 | 0) + hashRecord(dictHashableRecord)(Type_Row.RLProxy.value)(record) | 0;
                      };
                  });
              };
          };
  ...
  exports["hash"] = hash;
  exports["HashableRecord"] = HashableRecord;
  exports["hashRecord"] = hashRecord;
  exports["hashableInt"] = hashableInt;
  exports["hashableRecordNil"] = hashableRecordNil;
  exports["hashableRecordCons"] = hashableRecordCons;
  exports["hashableRecord"] = hashableRecord;
...
(function(exports) {
  ...
  var lookup = function (dictHashable) {
      return function (k) {
          return $foreign.lookupPurs(Data_Eq.eq(dictHashable.Eq0()), k, Data_Hashable.hash(dictHashable)(k));
      };
  };
...
(function(exports) {
  ...
  var ballSourceRadius = 4.0;
  var ballRadius = 10.0;
  exports["canvasSide"] = canvasSide;
  exports["betweenCells"] = betweenCells;
  exports["inkRadius"] = inkRadius;
  exports["ballRadius"] = ballRadius;
  exports["sinkHoleRadius"] = sinkHoleRadius;
  exports["ballSourceRadius"] = ballSourceRadius;
  exports["blockSide"] = blockSide;
  exports["sinkSide"] = sinkSide;
})(PS["InkBall.Constants"] = PS["InkBall.Constants"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  exports["board"] = board;
})(PS["InkBall.Boards"] = PS["InkBall.Boards"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Data_EuclideanRing = PS["Data.EuclideanRing"];
  ...
  var $$Math = PS["Math"];
  var Prelude = PS["Prelude"];
  var quadCurveToSegments = function (curve) {
      var segmentB = {
          p: curve.control,
          q: curve.end
      };
      ...
      return new Data_Tuple.Tuple(segmentA, segmentB);
  };
  ...
  var pointsToQuadCurves = function (points) {
      var toQuadCurve = function (v) {
          return {
              start: v.value0.value0,
              end: v.value0.value1,
              control: v.value1
          };
      };
      var v = new Data_Tuple.Tuple(Data_List.head(points), Data_List.last(points));
      if (v.value0 instanceof Data_Maybe.Just && v.value1 instanceof Data_Maybe.Just) {
          var n = Data_List.length(points);
          var slice1 = Data_List.slice(1)(n - 3 | 0)(points);
          var slice2 = Data_List.slice(2)(n - 2 | 0)(points);
          var midPoints = Data_List.zipWith(middlePoint)(slice1)(slice2);
          var startPoints = new Data_List_Types.Cons(v.value0.value0, midPoints);
          var endPoints = Data_List.snoc(midPoints)(v.value1.value0);
          var controlPoints = Data_List.slice(1)(n - 2 | 0)(points);
          return Data_Functor.map(Data_List_Types.functorList)(toQuadCurve)(Data_List.zip(Data_List.zip(startPoints)(endPoints))(controlPoints));
      };
      return Data_List_Types.Nil.value;
  };
  var splitQuadCurve = function (curve) {
      var q2 = middlePoint(curve.control)(curve.end);
      var q1 = middlePoint(curve.start)(curve.control);
      var q3 = middlePoint(q1)(q2);
      var curveB = {
          start: q3,
          control: q2,
          end: curve.end
      ...
      return new Data_Tuple.Tuple(curveA, curveB);
  };
  ...
  var closestPointOnSeg = function (point) {
      return function (seg) {
          var closestEndOnSeg = (function () {
              var $14 = distance(seg.p)(point) < distance(seg.q)(point);
              if ($14) {
                  return seg.p;
              };
              return seg.q;
          ...
          throw new Error("Failed pattern match at InkBall.Geometry line 140, column 7 - line 142, column 35: " + [ v.constructor.name ]);
      };
  };
  ...
  var circleIntersectSeg$prime = function (circle) {
      return function (seg) {
          var closestPoint = closestPointOnSeg(circle.center)(seg);
          var $17 = almostLessThanOrEqualTo(distance(circle.center)(closestPoint))(circle.radius);
          if ($17) {
              return new Data_Maybe.Just(closestPoint);
          };
          return Data_Maybe.Nothing.value;
      };
  };
  ...
  exports["circleIntersectSeg'"] = circleIntersectSeg$prime;
  ...
  exports["pointsToQuadCurves"] = pointsToQuadCurves;
  exports["splitQuadCurve"] = splitQuadCurve;
  exports["quadCurveToSegments"] = quadCurveToSegments;
})(PS["InkBall.Geometry"] = PS["InkBall.Geometry"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Apply = PS["Control.Apply"];
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Data_Unfoldable = PS["Data.Unfoldable"];
  var InkBall_Boards = PS["InkBall.Boards"];
  var InkBall_Constants = PS["InkBall.Constants"];
  var InkBall_Geometry = PS["InkBall.Geometry"];
  var Prelude = PS["Prelude"];
  var White = (function () {
      function White() {
  ...
  var showColor = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at InkBall.GameObjects line 47, column 1 - line 47, column 33: " + [ v.constructor.name ]);
  });
  var mkSink = function (coor) {
      return function (color) {
          var topLeft = {
              x: InkBall_Constants.betweenCells + (InkBall_Constants.blockSide + InkBall_Constants.betweenCells) * Data_Int.toNumber(coor.col),
              y: InkBall_Constants.betweenCells + (InkBall_Constants.blockSide + InkBall_Constants.betweenCells) * Data_Int.toNumber(coor.row)
          };
          return {
              square: {
                  topLeft: topLeft,
                  side: InkBall_Constants.sinkSide
              },
              circle: {
                  center: {
                      x: topLeft.x + InkBall_Constants.sinkSide / 2.0,
                      y: topLeft.y + InkBall_Constants.sinkSide / 2.0
                  },
                  radius: InkBall_Constants.sinkHoleRadius
              },
              color: color
          };
      };
  ...
  var mkInkDot = function (xy) {
      return {
          ...
          radius: InkBall_Constants.inkRadius
      };
  };
      ...
      return function (color) {
          return {
              square: {
                  ...
                  side: InkBall_Constants.blockSide
              },
              color: color
          };
      };
  };
  var mkBallSource = function (coor) {
      var topLeft = {
          x: InkBall_Constants.betweenCells + (InkBall_Constants.blockSide + InkBall_Constants.betweenCells) * Data_Int.toNumber(coor.col),
          y: InkBall_Constants.betweenCells + (InkBall_Constants.blockSide + InkBall_Constants.betweenCells) * Data_Int.toNumber(coor.row)
      };
      return {
          ...
          circle: {
              center: {
                  x: topLeft.x + InkBall_Constants.blockSide / 2.0,
                  y: topLeft.y + InkBall_Constants.blockSide / 2.0
              },
              radius: InkBall_Constants.ballSourceRadius
          }
      };
  };
  ...
  var enumBoard = (function () {
      ...
      var rows = enumerate(InkBall_Boards.board);
      var flatBoard = Data_List.concat(InkBall_Boards.board);
      var cols = enumerate(Data_Maybe.fromMaybe(Data_List_Types.Nil.value)(Data_List.head(InkBall_Boards.board)));
  ...
  var generateBallSources = (function () {
      var toBallSource = function (v) {
          return mkBallSource(v.value1);
      };
      var ballSourcesCells = Data_List.filter(function (v) {
          return v.value0 === "@";
      })(enumBoard);
      return Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_Functor.map(Data_List_Types.functorList)(toBallSource)(ballSourcesCells));
  })();
  var charToColor = function (c) {
      var smallCharToColor = function (v) {
          if (v === "g") {
              return Green.value;
          };
          if (v === "r") {
      ...
      return smallCharToColor(Data_Char_Unicode.toLower(c));
  };
  var generateBlocks = (function () {
      var toBlock = function (v) {
          return mkBlock(v.value1)(charToColor(v.value0));
      };
  ...
  var generateBlocksMap = (function () {
      var toBlock = function (v) {
          return new Data_Tuple.Tuple(v.value1, mkBlock(v.value1)(charToColor(v.value0)));
      };
      var blocksCells = Data_List.filter(function (v) {
          return Data_Char_Unicode.isUpper(v.value0);
      })(enumBoard);
      return Data_HashMap.fromFoldable(Data_List_Types.foldableList)(Data_Hashable.hashableRecord()(Data_Hashable.hashableRecordCons(Data_Hashable.hashableInt)(Data_Hashable.hashableRecordCons(Data_Hashable.hashableInt)(Data_Hashable.hashableRecordNil)(new Data_Symbol.IsSymbol(function () {
          return "row";
      }))())(new Data_Symbol.IsSymbol(function () {
          return "col";
      }))())(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
          return "row";
      }))(Data_Eq.eqInt))()(new Data_Symbol.IsSymbol(function () {
          return "col";
      }))(Data_Eq.eqInt)))(Data_Functor.map(Data_List_Types.functorList)(toBlock)(blocksCells));
  })();
  var generateSinks = (function () {
      var toSink = function (v) {
          return mkSink(v.value1)(charToColor(v.value0));
      };
  ...
  exports["generateBlocksMap"] = generateBlocksMap;
  exports["generateSinks"] = generateSinks;
  exports["generateBallSources"] = generateBallSources;
  exports["eqColor"] = eqColor;
  exports["showColor"] = showColor;
})(PS["InkBall.GameObjects"] = PS["InkBall.GameObjects"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var InkBall_Constants = PS["InkBall.Constants"];
  var InkBall_GameObjects = PS["InkBall.GameObjects"];
  var InkBall_Geometry = PS["InkBall.Geometry"];
  var $$Math = PS["Math"];
  var Prelude = PS["Prelude"];                 
  var neighborBlocks = function (ball) {
      var blockAt = function (coor) {
          return Data_HashMap.lookup(Data_Hashable.hashableRecord()(Data_Hashable.hashableRecordCons(Data_Hashable.hashableInt)(Data_Hashable.hashableRecordCons(Data_Hashable.hashableInt)(Data_Hashable.hashableRecordNil)(new Data_Symbol.IsSymbol(function () {
              return "row";
          }))())(new Data_Symbol.IsSymbol(function () {
              return "col";
          }))())(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              ...
              return "col";
          }))(Data_Eq.eqInt)))(coor)(InkBall_GameObjects.generateBlocksMap);
      };
      var angle = function (v) {
          var theta = $$Math.acos(InkBall_Geometry.dot(v)({
              x: 1.0,
              y: 0.0
          }) / InkBall_Geometry.magnitude(v));
          var sign = (function () {
              var $13 = v.y > 0.0;
              if ($13) {
                  return 1.0;
          ...
          var result = theta * sign;
          var $14 = result > 0.0;
          if ($14) {
              return result;
          };
          return 2.0 * $$Math.pi + result;
      };
      var z = angle(ball.velocity);
      var bc = {
          col: Data_Int.floor((ball.circle.center.x - InkBall_Constants.betweenCells) / (InkBall_Constants.blockSide + InkBall_Constants.betweenCells)),
          row: Data_Int.floor((ball.circle.center.y - InkBall_Constants.betweenCells) / (InkBall_Constants.blockSide + InkBall_Constants.betweenCells))
      };
      var dd = blockAt({
          row: bc.row + 1 | 0,
          col: bc.col
      ...
      var check = Data_Array.catMaybes((function () {
          var $15 = z >= 0.0 && z <= $$Math.pi / 2.0;
          if ($15) {
              return [ rr, rd, dd ];
          };
          var $16 = z >= $$Math.pi / 2.0 && z <= $$Math.pi;
          if ($16) {
              return [ dd, ld, ll ];
          };
          var $17 = z >= $$Math.pi && z <= (3.0 * $$Math.pi) / 2.0;
          if ($17) {
              return [ ll, lu, uu ];
          };
          var $18 = z >= (3.0 * $$Math.pi) / 2.0 && z <= 2.0 * $$Math.pi;
          if ($18) {
              return [ uu, ru, rr ];
          };
          return [  ];
  ...
  var fallInSink = function (sink) {
      return function (ball) {
          return InkBall_Geometry.circlesIntersect(sink.circle)(ball.circle);
      };
  };
  var collideWithInkDot = function (ball) {
      return function (v) {
          var touchPoint = InkBall_Geometry.circlesTouchingPoint(ball.circle)(v);
          var n = InkBall_Geometry.normalize(Data_Ring.sub(Data_Ring.ringRecord()(Data_Ring.ringRecordCons(new Data_Symbol.IsSymbol(function () {
              return "x";
          }))()(Data_Ring.ringRecordCons(new Data_Symbol.IsSymbol(function () {
              return "y";
          ...
          var v1 = Data_Ring.sub(Data_Ring.ringRecord()(Data_Ring.ringRecordCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "y";
          }))()(Data_Ring.ringRecordNil)(Data_Ring.ringNumber))(Data_Ring.ringNumber)))(ball.velocity)(InkBall_Geometry.multiplyByScalar(n)(2.0 * InkBall_Geometry.dot(ball.velocity)(n)));
          var $21 = InkBall_Geometry.circlesIntersect(ball.circle)(v);
          if ($21) {
              return new Data_Maybe.Just({
                  velocity: v1,
                  circle: ball.circle,
  ...
  var collideWithInkLine = function (ball) {
      return function (inkLine) {
          var f = function (v) {
              return new Data_List_Types.Cons(v.value0, new Data_List_Types.Cons(v.value1, Data_List_Types.Nil.value));
          };
          var curves = InkBall_Geometry.pointsToQuadCurves(Data_Functor.map(Data_List_Types.functorList)(function (v) {
              return v.center;
          })(Data_List.fromFoldable(Data_Foldable.foldableArray)(inkLine)));
          var curvesX4 = Data_List.concatMap(function ($41) {
              return (function (v) {
                  return Data_Semigroup.append(Data_List_Types.semigroupList)(f(InkBall_Geometry.splitQuadCurve(v.value0)))(f(InkBall_Geometry.splitQuadCurve(v.value1)));
              })(InkBall_Geometry.splitQuadCurve($41));
          })(curves);
          var segments = Data_List.concatMap(function ($42) {
              return f(InkBall_Geometry.quadCurveToSegments($42));
          })(curvesX4);
          var intersectionPoint = Data_Foldable.findMap(Data_List_Types.foldableList)(InkBall_Geometry["circleIntersectSeg'"](ball.circle))(segments);
          if (intersectionPoint instanceof Data_Maybe.Just) {
              return collideWithInkDot(ball)(InkBall_GameObjects.mkInkDot({
                  x: Data_Int.round(intersectionPoint.value0.x),
                  y: Data_Int.round(intersectionPoint.value0.y)
              }));
          };
          if (intersectionPoint instanceof Data_Maybe.Nothing) {
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at InkBall.Physics line 146, column 7 - line 148, column 27: " + [ intersectionPoint.constructor.name ]);
      };
  };
  var collideWithBall = function (ball) {
      return function (ball$prime) {
          var ballsCollide = InkBall_Geometry.circlesIntersect(ball.circle)(ball$prime.circle);
          var $31 = Data_Eq.notEq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "radius";
  ...
  var changeDirection = function (ball) {
      return function (v) {
          if (v instanceof InkBall_GameObjects.TopSide) {
              return {
                  circle: ball.circle,
                  velocity: {
                      x: ball.velocity.x,
          ...
          if (v instanceof InkBall_GameObjects.BottomSide) {
              return {
                  circle: ball.circle,
                  velocity: {
                      x: ball.velocity.x,
          ...
          if (v instanceof InkBall_GameObjects.LeftSide) {
              return {
                  circle: ball.circle,
                  velocity: {
          ...
          if (v instanceof InkBall_GameObjects.RightSide) {
              return {
                  circle: ball.circle,
                  velocity: {
                      x: Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(ball.velocity.x),
          ...
          throw new Error("Failed pattern match at InkBall.Physics line 120, column 1 - line 120, column 45: " + [ ball.constructor.name, v.constructor.name ]);
      };
  };
  var collideWithBlock = function (ball) {
      return function (block) {
          var newBallColor = (function () {
              var $34 = Data_Eq.eq(InkBall_GameObjects.eqColor)(block.color)(InkBall_GameObjects.White.value);
              if ($34) {
                  return ball.color;
              };
              return block.color;
          ...
          var topRight = {
              x: block.square.topLeft.x + InkBall_Constants.blockSide,
              y: block.square.topLeft.y
          };
          var topSeg = {
              p: topLeft,
          ...
          var topIntersect = InkBall_Geometry.circleIntersectSeg(ball.circle)(topSeg);
          var bottomRight = {
              x: block.square.topLeft.x + InkBall_Constants.blockSide,
              y: block.square.topLeft.y + InkBall_Constants.blockSide
          };
          var rightSeg = {
              p: topRight,
              q: bottomRight
          };
          var rightIntersect = InkBall_Geometry.circleIntersectSeg(ball.circle)(rightSeg);
          var bottomLeft = {
              x: block.square.topLeft.x,
              y: block.square.topLeft.y + InkBall_Constants.blockSide
          };
          ...
          var leftIntersect = InkBall_Geometry.circleIntersectSeg(ball.circle)(leftSeg);
          var bottomIntersect = InkBall_Geometry.circleIntersectSeg(ball.circle)(bottomSeg);
          var detectSide = (function () {
              if (topIntersect && leftIntersect) {
                  var $35 = InkBall_Geometry.pointToSegEnds(ball.circle.center)(topSeg) < InkBall_Geometry.pointToSegEnds(ball.circle.center)(leftSeg);
                  if ($35) {
                      return new Data_Maybe.Just(InkBall_GameObjects.TopSide.value);
                  };
                  return new Data_Maybe.Just(InkBall_GameObjects.LeftSide.value);
              };
              if (topIntersect && rightIntersect) {
                  var $36 = InkBall_Geometry.pointToSegEnds(ball.circle.center)(topSeg) < InkBall_Geometry.pointToSegEnds(ball.circle.center)(rightSeg);
                  if ($36) {
                      return new Data_Maybe.Just(InkBall_GameObjects.TopSide.value);
                  };
                  return new Data_Maybe.Just(InkBall_GameObjects.RightSide.value);
              };
              if (bottomIntersect && leftIntersect) {
                  var $37 = InkBall_Geometry.pointToSegEnds(ball.circle.center)(bottomSeg) < InkBall_Geometry.pointToSegEnds(ball.circle.center)(leftSeg);
                  if ($37) {
                      return new Data_Maybe.Just(InkBall_GameObjects.BottomSide.value);
                  };
                  return new Data_Maybe.Just(InkBall_GameObjects.LeftSide.value);
              };
              if (bottomIntersect && rightIntersect) {
                  var $38 = InkBall_Geometry.pointToSegEnds(ball.circle.center)(bottomSeg) < InkBall_Geometry.pointToSegEnds(ball.circle.center)(rightSeg);
                  if ($38) {
                      return new Data_Maybe.Just(InkBall_GameObjects.BottomSide.value);
                  };
                  return new Data_Maybe.Just(InkBall_GameObjects.RightSide.value);
              ...
              throw new Error("Failed pattern match at InkBall.Physics line 83, column 5 - line 83, column 34: " + [  ]);
          })();
          ...
          throw new Error("Failed pattern match at InkBall.Physics line 79, column 3 - line 81, column 25: " + [ detectSide.constructor.name ]);
      };
  };
  exports["moveBall"] = moveBall;
  exports["fallInSink"] = fallInSink;
  exports["neighborBlocks"] = neighborBlocks;
  exports["collideWithBlock"] = collideWithBlock;
  exports["collideWithBall"] = collideWithBall;
  exports["collideWithInkLine"] = collideWithInkLine;
})(PS["InkBall.Physics"] = PS["InkBall.Physics"] || {});
(function(exports) {
...
(function(exports) {
  ...
  var Data_Semigroup = PS["Data.Semigroup"];
  var InkBall_GameObjects = PS["InkBall.GameObjects"];
  var InkBall_Physics = PS["InkBall.Physics"];
  var Prelude = PS["Prelude"];
  var Signal_DOM = PS["Signal.DOM"];                 
  var MousePos = (function () {
      function MousePos(value0) {
          this.value0 = value0;
      };
      MousePos.create = function (value0) {
          return new MousePos(value0);
      };
      return MousePos;
  })();
  var LaunchBall = (function () {
      function LaunchBall(value0) {
          this.value0 = value0;
      };
      LaunchBall.create = function (value0) {
          return new LaunchBall(value0);
      };
      return LaunchBall;
  })();
  ...
  var initialState = {
      balls: Data_List_Types.Nil.value,
      blocks: Data_List.fromFoldable(Data_Foldable.foldableArray)(InkBall_GameObjects.generateBlocks),
      sinks: Data_List.fromFoldable(Data_Foldable.foldableArray)(InkBall_GameObjects.generateSinks),
  ...
  var nextState = function (signal) {
      return function (gameState) {
          var notInSink = function (sink) {
              return Data_List.filter(function ($22) {
                  return !InkBall_Physics.fallInSink(sink)($22);
              });
          };
          var notHitInkLine = function (ball) {
              return function (inkLines) {
                  var unhit = Data_List_NonEmpty.filter(function ($23) {
                      return Data_Maybe.isNothing(InkBall_Physics.collideWithInkLine(ball)($23));
                  })(inkLines);
                  var v = Data_List_NonEmpty.fromList(unhit);
                  if (v instanceof Data_Maybe.Just) {
                      var $10 = Data_Maybe.isJust(InkBall_Physics.collideWithInkLine(ball)(Data_List_NonEmpty.head(inkLines)));
                      if ($10) {
                          return Data_List_NonEmpty.cons([  ])(v.value0);
                      };
                      return v.value0;
                  };
                  if (v instanceof Data_Maybe.Nothing) {
                  ...
                  throw new Error("Failed pattern match at InkBall.State line 108, column 11 - line 115, column 53: " + [ v.constructor.name ]);
              };
          };
          var fallInWrongSink = function (ball) {
              return function (sink) {
                  return InkBall_Physics.fallInSink(ball)(sink) && Data_Eq.notEq(InkBall_GameObjects.eqColor)(ball.color)(sink.color);
              };
          };
          var afterCollisionWithInkLine = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_Foldable.findMap(Data_List_Types.foldableNonEmptyList)(InkBall_Physics.collideWithInkLine(ball))(gameState.inkLines));
          };
          var afterCollisionWithBlock = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_Foldable.findMap(Data_Foldable.foldableArray)(InkBall_Physics.collideWithBlock(ball))(InkBall_Physics.neighborBlocks(ball)));
          };
          var afterCollisionWithBall = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_Foldable.findMap(Data_List_Types.foldableList)(InkBall_Physics.collideWithBall(ball))(gameState.balls));
          };
          var afterCollision = function ($24) {
              return afterCollisionWithBlock(afterCollisionWithBall(afterCollisionWithInkLine($24)));
          };
          if (signal instanceof LaunchBall && signal.value0 instanceof Data_Maybe.Just) {
              return {
                  balls: new Data_List_Types.Cons(signal.value0.value0, gameState.balls),
                  blocks: gameState.blocks,
                  sinks: gameState.sinks,
                  inkLines: gameState.inkLines,
                  status: gameState.status
              };
          };
          if (signal instanceof MousePos) {
              var $15 = Data_Eq.eq(eqGameStatus)(gameState.status)(Playing.value);
              if ($15) {
                  var newInkLines = (function () {
                      if (signal.value0 instanceof Data_Maybe.Just) {
                          var remainingLines = Data_List_NonEmpty.tail(gameState.inkLines);
                          var firstLine = Data_List_NonEmpty.head(gameState.inkLines);
                          var newFirstLine = Data_Semigroup.append(Data_Semigroup.semigroupArray)(firstLine)([ InkBall_GameObjects.mkInkDot(signal.value0.value0) ]);
                          return Data_List_Types.NonEmptyList(new Data_NonEmpty.NonEmpty(newFirstLine, remainingLines));
                      };
                      if (signal.value0 instanceof Data_Maybe.Nothing) {
                          var v = Data_List_NonEmpty.head(gameState.inkLines);
                          if (v.length === 0) {
                              return gameState.inkLines;
                          };
                          return Data_List_NonEmpty.cons([  ])(gameState.inkLines);
                      };
                      throw new Error("Failed pattern match at InkBall.State line 64, column 17 - line 73, column 58: " + [ signal.value0.constructor.name ]);
                  })();
                  ...
                  var newBalls = Data_Functor.map(Data_List_Types.functorList)(function ($25) {
                      return InkBall_Physics.moveBall(afterCollision($25));
                  })(ballsNotInSinks);
                  var newStatus = (function () {
                      if (lost) {
                          return Lost.value;
                      };
                      var $20 = Data_Foldable["null"](Data_List_Types.foldableList)(newBalls);
                      if ($20) {
                          return Won.value;
                      };
...
(function(exports) {
  ...
  var InkBall_GameObjects = PS["InkBall.GameObjects"];
  var InkBall_Geometry = PS["InkBall.Geometry"];
  var InkBall_State = PS["InkBall.State"];
  var $$Math = PS["Math"];
  var Prelude = PS["Prelude"];                 
  var drawSquare = function (ctx) {
      return function (square) {
          return function (color) {
              var clr = Data_Show.show(InkBall_GameObjects.showColor)(color);
              return function __do() {
  ...
  var drawInkLine = function (ctx) {
      return function (inkLine) {
          ...
          if (len === 1) {
              var uselessPoint = InkBall_GameObjects.mkInkDot({
                  x: 500,
                  y: 500
              });
          ...
          return function __do() {
              Graphics_Canvas.beginPath(ctx)();
              Graphics_Canvas.moveTo(ctx)(firstPoint.x)(firstPoint.y)();
              Effect.foreachE(Data_Array.zip(middle)(midPoints))(function ($23) {
                  return Graphics_Canvas.quadraticCurveTo(ctx)(f($23));
              })();
  ...
  var drawSink = function (ctx) {
      return function (sink) {
          return function __do() {
              ...
              return drawCircle(ctx)(sink.circle)(InkBall_GameObjects.Black.value)();
          };
      };
  };
  ...
  var drawBallSource = function (ctx) {
      return function (ballSource) {
          return function __do() {
              drawSquare(ctx)(ballSource.square)(InkBall_GameObjects.Gray.value)();
              return drawCircle(ctx)(ballSource.circle)(InkBall_GameObjects.Black.value)();
          };
      };
  };
  ...
  var drawForeground = function (gameState) {
      var showText = function (ctx) {
          return function (text) {
              return function (color) {
                  return function __do() {
                      Graphics_Canvas.setFont(ctx)("50px Comic Sans MS")();
                      Graphics_Canvas.setFillStyle(ctx)(Data_Show.show(InkBall_GameObjects.showColor)(color))();
                      Graphics_Canvas.setTextAlign(ctx)(Graphics_Canvas.AlignCenter.value)();
                      return Graphics_Canvas.fillText(ctx)(text)(InkBall_Constants.canvasSide / 2.0)(InkBall_Constants.canvasSide / 2.0)();
                  };
              };
          };
      };
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Just) {
              Graphics_Canvas.setCanvasWidth(v.value0)(InkBall_Constants.canvasSide)();
              Graphics_Canvas.setCanvasHeight(v.value0)(InkBall_Constants.canvasSide)();
              var v1 = Graphics_Canvas.getContext2D(v.value0)();
              Graphics_Canvas.clearRect(v1)({
                  x: 0.0,
                  y: 0.0,
                  width: InkBall_Constants.canvasSide,
                  height: InkBall_Constants.canvasSide
              })();
              if (gameState.status instanceof InkBall_State.Playing) {
                  Effect.foreachE(Data_List_NonEmpty.toUnfoldable(Data_Unfoldable.unfoldableArray)(gameState.inkLines))(drawInkLine(v1))();
                  return Effect.foreachE(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(gameState.balls))(drawBall(v1))();
              };
              if (gameState.status instanceof InkBall_State.Won) {
                  return showText(v1)("You Won")(InkBall_GameObjects.Green.value)();
              };
              if (gameState.status instanceof InkBall_State.Lost) {
                  return showText(v1)("You Lost")(InkBall_GameObjects.Red.value)();
              };
              throw new Error("Failed pattern match at InkBall.Graphics line 53, column 7 - line 58, column 44: " + [ gameState.status.constructor.name ]);
          };
          if (v instanceof Data_Maybe.Nothing) {
              return Data_Unit.unit;
          };
          throw new Error("Failed pattern match at InkBall.Graphics line 47, column 3 - line 59, column 25: " + [ v.constructor.name ]);
      };
  };
  var drawBackground = function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          Graphics_Canvas.setCanvasHeight(v.value0)(InkBall_Constants.canvasSide)();
          var v1 = Graphics_Canvas.getContext2D(v.value0)();
          Graphics_Canvas.setFillStyle(v1)(Data_Show.show(InkBall_GameObjects.showColor)(InkBall_GameObjects.DarkGray.value))();
          ...
          Effect.foreachE(InkBall_GameObjects.generateBlocks)(drawBlock(v1))();
          Effect.foreachE(InkBall_GameObjects.generateSinks)(drawSink(v1))();
          return Effect.foreachE(InkBall_GameObjects.generateBallSources)(drawBallSource(v1))();
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Data_Unit.unit;
      };
      throw new Error("Failed pattern match at InkBall.Graphics line 27, column 3 - line 42, column 25: " + [ v.constructor.name ]);
  };
  exports["drawBackground"] = drawBackground;
  exports["drawForeground"] = drawForeground;
})(PS["InkBall.Graphics"] = PS["InkBall.Graphics"] || {});
...
(function(exports) {
  ...
  var Web_HTML_HTMLElement = PS["Web.HTML.HTMLElement"];
  var Web_HTML_Window = PS["Web.HTML.Window"];                 
  var randomBallsGenerator = function (ballsChannel) {
      var sampleBall = {
          circle: {
              center: {
                  x: 100.0,
              ...
              radius: InkBall_Constants.ballRadius
          },
          velocity: {
              x: 0.0,
              y: 2.0
          },
          color: InkBall_GameObjects.Red.value
      };
      var sinksColors = Data_Functor.map(Data_Functor.functorArray)(function (sink) {
          return sink.color;
      })(InkBall_GameObjects.generateSinks);
      return function __do() {
          var v = Effect_Random.randomInt(0)(Data_Array.length(sinksColors) - 1 | 0)();
          var ballColor = (function () {
              var v1 = Data_Array.index(sinksColors)(v);
              if (v1 instanceof Data_Maybe.Just) {
                  return v1.value0;
              };
              if (v1 instanceof Data_Maybe.Nothing) {
                  return InkBall_GameObjects.White.value;
              };
              throw new Error("Failed pattern match at InkBall.Signals line 53, column 19 - line 55, column 37: " + [ v1.constructor.name ]);
          })();
          var v1 = Effect_Random.randomRange(-$$Math.pi)($$Math.pi)();
          var v2 = Effect_Random.randomInt(0)(Data_Array.length(InkBall_GameObjects.generateBallSources) - 1 | 0)();
          var v3 = Data_Array.index(InkBall_GameObjects.generateBallSources)(v2);
          if (v3 instanceof Data_Maybe.Just) {
              var ball = {
                  velocity: {
                      x: sampleBall.velocity.x * $$Math.cos(v1) - sampleBall.velocity.y * $$Math.sin(v1),
                      y: sampleBall.velocity.x * $$Math.sin(v1) + sampleBall.velocity.y * $$Math.cos(v1)
                  },
                  circle: {
                      center: v3.value0.circle.center,
                      radius: sampleBall.circle.radius
                  },
                  color: ballColor
              };
              return Signal_Channel.send(ballsChannel)(new Data_Maybe.Just(ball))();
          };
          if (v3 instanceof Data_Maybe.Nothing) {
              return Data_Unit.unit;
          };
          throw new Error("Failed pattern match at InkBall.Signals line 59, column 3 - line 76, column 25: " + [ v3.constructor.name ]);
      };
  };
  var launchBallSignal = function __do() {
      var v = Signal_Channel.channel(Data_Maybe.Nothing.value)();
      Signal.runSignal(Signal.flippedMap(Signal.functorSignal)(Signal_Time.every(3000.0))(function (v1) {
          return randomBallsGenerator(v);
      }))();
      return Data_Functor.map(Signal.functorSignal)(InkBall_State.LaunchBall.create)(Signal_Channel.subscribe(v));
  };
  var gameSignal = function (signal) {
      return Signal.foldp(InkBall_State.nextState)(InkBall_State.initialState)(signal);
  };
  var canvasOffset = function __do() {
      var v = Web_HTML.window();
      var v1 = Web_HTML_Window.document(v)();
      var parentNode = Web_DOM_Document.toNonElementParentNode(Web_HTML_HTMLDocument.toDocument(v1));
      var v2 = Web_DOM_NonElementParentNode.getElementById("canvas-wrapper")(parentNode)();
  ...
  var mousePosWhenClicked = function (pressed) {
      return function (posChannel) {
          return function (coor) {
              var validateCoordinates = function (coordinatePair) {
                  var validY = coordinatePair.y >= 0 && coordinatePair.y <= Data_Int.round(InkBall_Constants.canvasSide);
                  var validX = coordinatePair.x >= 0 && coordinatePair.x <= Data_Int.round(InkBall_Constants.canvasSide);
                  return validX && validY;
              };
              return function __do() {
                  var v = Signal.get(pressed)();
                  if (v) {
                      var v1 = canvasOffset();
                      ...
                      var $39 = validateCoordinates(coorInCanvas);
                      if ($39) {
                          return Signal_Channel.send(posChannel)(new Data_Maybe.Just(coorInCanvas))();
                      };
                      return Signal_Channel.send(posChannel)(Data_Maybe.Nothing.value)();
                  };
                  return Signal_Channel.send(posChannel)(Data_Maybe.Nothing.value)();
              };
          };
  ...
  var mousePosEveryFrame = function __do() {
      var v = Signal_DOM.mousePos();
      var v1 = Signal_DOM.mouseButtonPressed(Signal_DOM.MouseLeftButton.value)();
      var v2 = Signal_Channel.channel(Data_Maybe.Nothing.value)();
      var posNoRepeats = Signal.dropRepeats(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
          return "y";
      }))(Data_Eq.eqInt))()(new Data_Symbol.IsSymbol(function () {
          return "x";
      }))(Data_Eq.eqInt)))(v);
      var posOnPress = Signal.sampleOn(v1)(posNoRepeats);
      var posOnPressOrMove = Data_Semigroup.append(Signal.semigroupSignal)(posOnPress)(posNoRepeats);
      Signal.runSignal(Signal.flippedMap(Signal.functorSignal)(posOnPressOrMove)(mousePosWhenClicked(v1)(v2)))();
      var v3 = Signal_DOM.animationFrame();
      return Data_Functor.map(Signal.functorSignal)(InkBall_State.MousePos.create)(Signal.sampleOn(v3)(Signal_Channel.subscribe(v2)));
  };
  exports["gameSignal"] = gameSignal;
  exports["mousePosEveryFrame"] = mousePosEveryFrame;
  exports["launchBallSignal"] = launchBallSignal;
})(PS["InkBall.Signals"] = PS["InkBall.Signals"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_Unit = PS["Data.Unit"];
  var Effect = PS["Effect"];
  var InkBall_Graphics = PS["InkBall.Graphics"];
  var InkBall_Signals = PS["InkBall.Signals"];
  var Prelude = PS["Prelude"];
  var Signal = PS["Signal"];                 
  var main = function __do() {
      InkBall_Graphics.drawBackground();
      var v = InkBall_Signals.mousePosEveryFrame();
      var v1 = InkBall_Signals.launchBallSignal();
      Signal.runSignal(Signal.flippedMap(Signal.functorSignal)(InkBall_Signals.gameSignal(Data_Semigroup.append(Signal.semigroupSignal)(v1)(v)))(InkBall_Graphics.drawForeground))();
      return Data_Unit.unit;
  };
  exports["main"] = main;
})(PS["InkBall"] = PS["InkBall"] || {});
PS["InkBall"].main();