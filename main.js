...
(function(exports) {
  ...
  var closestPointOnSeg = function (point) {
      return function (seg) {
          ...
          throw new Error("Failed pattern match at InkBall.Geometry line 117, column 7 - line 119, column 35: " + [ v.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var showColor = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at InkBall.GameObjects line 43, column 1 - line 43, column 33: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var changeDirection = function (ball) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at InkBall.Physics line 76, column 1 - line 76, column 45: " + [ ball.constructor.name, v.constructor.name ]);
      };
  };
  var collide = function (ball) {
      return function (block) {
          var newBallColor = (function () {
              var $12 = Data_Eq.eq(InkBall_GameObjects.eqColor)(block.color)(InkBall_GameObjects.White.value);
              if ($12) {
                  return ball.color;
              };
              return block.color;
          ...
          var detectSide = (function () {
              if (topIntersect && leftIntersect) {
                  var $13 = InkBall_Geometry.pointToSegEnds(ball.circle.center)(topSeg) < InkBall_Geometry.pointToSegEnds(ball.circle.center)(leftSeg);
                  if ($13) {
              ...
              if (topIntersect && rightIntersect) {
                  var $14 = InkBall_Geometry.pointToSegEnds(ball.circle.center)(topSeg) < InkBall_Geometry.pointToSegEnds(ball.circle.center)(rightSeg);
                  if ($14) {
                      return new Data_Maybe.Just(InkBall_GameObjects.TopSide.value);
                  };
              ...
              if (bottomIntersect && leftIntersect) {
                  var $15 = InkBall_Geometry.pointToSegEnds(ball.circle.center)(bottomSeg) < InkBall_Geometry.pointToSegEnds(ball.circle.center)(leftSeg);
                  if ($15) {
              ...
              if (bottomIntersect && rightIntersect) {
                  var $16 = InkBall_Geometry.pointToSegEnds(ball.circle.center)(bottomSeg) < InkBall_Geometry.pointToSegEnds(ball.circle.center)(rightSeg);
                  if ($16) {
                      return new Data_Maybe.Just(InkBall_GameObjects.BottomSide.value);
                  };
                  return new Data_Maybe.Just(InkBall_GameObjects.RightSide.value);
              ...
              throw new Error("Failed pattern match at InkBall.Physics line 39, column 5 - line 39, column 34: " + [  ]);
          })();
          ...
          throw new Error("Failed pattern match at InkBall.Physics line 35, column 3 - line 37, column 25: " + [ detectSide.constructor.name ]);
      };
  };
  ...
  var ballCollideWithInkLine = function (ball) {
      return function (ink) {
          return Data_Foldable.findMap(Data_Foldable.foldableArray)(ballCollideWithInkDot(ball))(ink);
      };
  };
  ...
  var nextState = function (signal) {
      return function (gameState) {
          ...
          var notHitInkLine = function (ball) {
              return function (inkLines) {
                  var unhit = Data_List_NonEmpty.filter(function ($23) {
                      return Data_Maybe.isNothing(InkBall_Physics.ballCollideWithInkLine(ball)($23));
                  })(inkLines);
                  var v = Data_List_NonEmpty.fromList(unhit);
                  if (v instanceof Data_Maybe.Just) {
                      var $10 = Data_Maybe.isJust(InkBall_Physics.ballCollideWithInkLine(ball)(Data_List_NonEmpty.head(inkLines)));
                      if ($10) {
                  ...
                  throw new Error("Failed pattern match at InkBall.State line 107, column 11 - line 114, column 53: " + [ v.constructor.name ]);
              };
          };
          ...
          var afterCollisionWithInkLine = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_Foldable.findMap(Data_List_Types.foldableNonEmptyList)(InkBall_Physics.ballCollideWithInkLine(ball))(gameState.inkLines));
          };
          var afterCollisionWithBlock = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_Foldable.findMap(Data_List_Types.foldableList)(InkBall_Physics.collide(ball))(gameState.blocks));
          };
          var afterCollisionWithBall = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_Foldable.findMap(Data_List_Types.foldableList)(InkBall_Physics.ballCollideWithBall(ball))(gameState.balls));
          };
          ...
          if (signal instanceof MousePos) {
              ...
              if ($15) {
                  var newInkLines = (function () {
                      ...
                      throw new Error("Failed pattern match at InkBall.State line 63, column 17 - line 72, column 58: " + [ signal.value0.constructor.name ]);
                  })();
...
(function(exports) {
  ...
  var randomBallsGenerator = function (ballsChannel) {
      ...
      return function __do() {
          var v = Effect_Random.randomRange(-$$Math.pi)($$Math.pi)();
          var v1 = Effect_Random.randomInt(0)(Data_Array.length(InkBall_GameObjects.generateBallSources) - 1 | 0)();
          var v2 = Data_Array.index(InkBall_GameObjects.generateBallSources)(v1);
          if (v2 instanceof Data_Maybe.Just) {
              var ball = {
                  velocity: {
                      x: sampleBall.velocity.x * $$Math.cos(v) - sampleBall.velocity.y * $$Math.sin(v),
                      y: sampleBall.velocity.x * $$Math.sin(v) + sampleBall.velocity.y * $$Math.cos(v)
                  },
                  circle: {
                      center: v2.value0.circle.center,
                      radius: sampleBall.circle.radius
                  },
                  color: sampleBall.color
              };
          ...
          throw new Error("Failed pattern match at InkBall.Signals line 54, column 3 - line 70, column 25: " + [ v2.constructor.name ]);
      };
  };
          ...
          return function (coor) {
              ...
              return function __do() {
                  ...
                  if (v) {
                      ...
                      var $34 = validateCoordinates(coorInCanvas);
                      if ($34) {
