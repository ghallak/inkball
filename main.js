...
(function(exports) {
  ...
  var showColor = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at GameObjects line 39, column 1 - line 39, column 33: " + [ v.constructor.name ]);
  });
  var inkRadius = 6.0;
...
(function(exports) {
  ...
  var changeDirection = function (ball) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Physics line 73, column 1 - line 73, column 45: " + [ ball.constructor.name, v.constructor.name ]);
      };
  };
      ...
      return function (block) {
          ...
          var detectSide = (function () {
              if (topIntersect && leftIntersect) {
                  var $11 = Geometry.pointToSegEnds(ball.circle.center)(topSeg) < Geometry.pointToSegEnds(ball.circle.center)(leftSeg);
                  if ($11) {
              ...
              if (topIntersect && rightIntersect) {
                  var $12 = Geometry.pointToSegEnds(ball.circle.center)(topSeg) < Geometry.pointToSegEnds(ball.circle.center)(rightSeg);
                  if ($12) {
                      return new Data_Maybe.Just(GameObjects.TopSide.value);
                  };
              ...
              if (bottomIntersect && leftIntersect) {
                  var $13 = Geometry.pointToSegEnds(ball.circle.center)(bottomSeg) < Geometry.pointToSegEnds(ball.circle.center)(leftSeg);
                  if ($13) {
              ...
              if (bottomIntersect && rightIntersect) {
                  var $14 = Geometry.pointToSegEnds(ball.circle.center)(bottomSeg) < Geometry.pointToSegEnds(ball.circle.center)(rightSeg);
                  if ($14) {
                      return new Data_Maybe.Just(GameObjects.BottomSide.value);
                  };
                  return new Data_Maybe.Just(GameObjects.RightSide.value);
          ...
          if (detectSide instanceof Data_Maybe.Just) {
              return Data_Maybe.Just.create(changeDirection(ball)(detectSide.value0));
          };
  ...
  var ballCollideWithInkDot = function (ball) {
      return function (v) {
          ...
          var $19 = Geometry.circlesIntersect(ball.circle)(v);
          if ($19) {
              return new Data_Maybe.Just({
                  velocity: v1,
                  circle: ball.circle,
  ...
  var ballCollideWithBall = function (ball) {
      return function (ball$prime) {
          ...
          var $20 = Data_Eq.notEq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "radius";
...
(function(exports) {
  ...
  var nextState = function (mCoor) {
      return function (gameState) {
          var notInSink = function (sink) {
              return Data_List.filter(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Physics.fallInSink(sink)));
          };
          var afterCollisionWithInkLine = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_List.head(Data_List.catMaybes(Data_List.fromFoldable(Data_List_Types.foldableNonEmptyList)(Data_Functor.map(Data_List_Types.functorNonEmptyList)(Physics.ballCollideWithInkLine(ball))(gameState.inkLines)))));
          };
          var afterCollisionWithBlock = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_List.head(Data_List.catMaybes(Data_List.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Physics.collide(ball))(gameState.blocks)))));
          };
          var afterCollisionWithBall = function (ball) {
              return Data_Maybe.fromMaybe(ball)(Data_List.head(Data_List.catMaybes(Data_List.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Physics.ballCollideWithBall(ball))(gameState.balls)))));
          };
          var afterCollision = function ($68) {
              return afterCollisionWithBlock(afterCollisionWithBall(afterCollisionWithInkLine($68)));
          };
          var $24 = Data_Eq.eq(GameObjects.eqGameStatus)(gameState.status)(GameObjects.Playing.value);
          if ($24) {
              var newInkLines = (function () {
                  ...
                  throw new Error("Failed pattern match at Main line 75, column 13 - line 81, column 55: " + [ mCoor.constructor.name ]);
              })();
              ...
              var newBalls = Data_Functor.map(Data_List_Types.functorList)(function ($69) {
                  return Physics.moveBall(afterCollision($69));
              })(ballsNotInSinks);
              var newStatus = (function () {
                  if (lost) {
                      return GameObjects.Lost.value;
                  };
                  var $28 = Data_Foldable["null"](Data_List_Types.foldableList)(newBalls);
                  if ($28) {
  ...
  var drawAll = function (ctx) {
      return function (gameState) {
          ...
          return function __do() {
              ...
              throw new Error("Failed pattern match at Main line 125, column 3 - line 130, column 36: " + [ gameState.status.constructor.name ]);
          };
      };
  };
          ...
          return function (coor) {
              ...
              return function __do() {
                  ...
                  if (v) {
                      ...
                      var $41 = validateCoordinates(coorInCanvas);
                      if ($41) {
  ...
  var board = Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Data_List.fromFoldable(Data_Foldable.foldableArray))([ [ "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W" ], [ "W", ".", "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "r", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", "W", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", "g", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "W" ], [ "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W", "W" ] ]));
  ...
  var drawBackground = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 142, column 3 - line 156, column 25: " + [ v.constructor.name ]);
  };
  var initialState = {
  ...
  var main = function __do() {
      drawBackground();
      Effect_Console.log(Data_Show.show(Data_Show.showInt)(Data_List.length(enumBoard)))();
      ...
      throw new Error("Failed pattern match at Main line 257, column 3 - line 271, column 21: " + [ v.constructor.name ]);
  };
